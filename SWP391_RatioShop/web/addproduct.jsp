            ...
            <div class="form-container">
                ...
                <form action="addproduct" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control" name="productName" id="name" placeholder="Type name in here.....">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="about">Description</label>
                        <div>
                            <textarea name="description"  style="min-height: 120px" class="form-control" placeholder="Type description of product here...."></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="qty">Unit Price (VND)</label>
                        <div>
                            <input type="number" class="form-control" name="unitPrice"  min="1" style="max-width: 250px"> 
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <label class="radio-inline">
                                <input type="radio" name="status" id="inlineRadio1" value="1"> Ready to Sell
                            </label>
                            <label class="radio-inline" style="margin-left: 20px">
                                <input type="radio" name="status" id="inlineRadio2" value="0"> Not ready
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control" name="cate">
                                <c:forEach items="${listCate}" var="cate">
                                    <option value="${cate.categoryId}">${cate.categoryName}. ${cate.categoryDescription}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
