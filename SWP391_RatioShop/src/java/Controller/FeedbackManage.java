 ...
 * @author admin
 */
@WebServlet(name = "FeedbackManage", urlPatterns = {"/feedback-manage"})
        ...
        if (request.getParameter("status") != null) {
            ...
            if (status.equals("-1")) {
                ...
                try {
                    ...
                    daoF.removeFeedback(feedbackId);
                    response.sendRedirect("feedback-manage");
                } catch (Exception e) {
                }
            }
        } else {
            request.setAttribute("listF", daoF.getAllFeedback());
